...
namespace boost { namespace spirit { namespace traits
{
    ...
    struct assign_to_attribute_from_iterators
    {
        // Common case
        static void
        call(Iterator const& first, Iterator const& last, Attribute& my_attr, mpl::false_)
        {
            if (traits::is_empty(my_attr))
                my_attr = Attribute(first, last);
            else {
        ...
        static void
        call(Iterator const& first, Iterator const& last, Attribute& my_attr, mpl::true_)
        {
            typename Attribute::value_type rng(first, last);
            push_back(my_attr, rng);
        }

        static void
        call(Iterator const& first, Iterator const& last, Attribute& my_attr)
        {
            call(first, last, my_attr, detail::is_container_of_ranges<Attribute>());
        }
    };
        ...
        reference_wrapper<Attribute>, Iterator>
    {
        ...
        call(Iterator const& first, Iterator const& last
          , reference_wrapper<Attribute> my_attr)
        {
            if (traits::is_empty(my_attr))
                my_attr = Attribute(first, last);
            else {
        ...
        boost::optional<Attribute>, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last
          , boost::optional<Attribute>& my_attr)
        {
            Attribute val;
        ...
        iterator_range<Iterator>, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last
          , iterator_range<Iterator>& my_attr)
        {
            my_attr = iterator_range<Iterator>(first, last);
        }
    };

    template <typename Iterator, typename Attribute>
    inline void
    assign_to(Iterator const& first, Iterator const& last, Attribute& my_attr)
    {
        assign_to_attribute_from_iterators<Attribute, Iterator>::
            call(first, last, my_attr);
    }
    ...
    void assign_to(T const& val, Attribute& my_attr);
    ...
    struct assign_to_attribute_from_value
    {
        ...
        static void
        call(T_ const& val, Attribute& my_attr, mpl::false_)
        {
            my_attr = static_cast<Attribute>(val);
        }
        ...
        template <typename T_>
        static void
        call(T_ const& val, Attribute& my_attr, mpl::true_)
        {
            typedef typename fusion::result_of::value_at_c<Attribute, 0>::type
                element_type;
            fusion::at_c<0>(my_attr) = static_cast<element_type>(val);
        }

        static void
        call(T const& val, Attribute& my_attr)
        {
            call(val, my_attr, is_one_element_sequence());
        }
    };
    ...
    {
        static void
        call(Attribute const& val, Attribute& my_attr)
        {
            my_attr = val;
        }
    };
    ...
    {
        static void
        call(reference_wrapper<T> const& val, Attribute& my_attr)
        {
            assign_to(val.get(), my_attr);
        }
    };
    ...
    {
        static void
        call(boost::optional<T> const& val, Attribute& my_attr)
        {
            assign_to(val.get(), my_attr);
        }
    };
    ...
    {
        static void
        call(T const& val, typename fusion::extension::adt_attribute_proxy<Attribute, N, Const>& my_attr)
        {
            my_attr = val;
        }
    };
    ...
    struct assign_to_container_from_value
    {
        ...
        template <typename T_>
        static void call(T_ const& val, Attribute& my_attr, mpl::false_, mpl::false_)
        {
            traits::push_back(my_attr, val);
        }
        ...
        template <typename T_>
        static void 
        append_to_container_not_string(T_ const& val, Attribute& my_attr, mpl::true_)
        {
            traits::push_back(my_attr, val);
        }
        ...
        template <typename T_>
        static void 
        append_to_container_not_string(T_ const& val, Attribute& my_attr, mpl::false_)
        {
            ...
            for (iterator_type i = traits::begin(val); i != end; traits::next(i))
                traits::push_back(my_attr, traits::deref(i));
        }

        // T is a container (but not a string)
        template <typename T_>
        static void call(T_ const& val, Attribute& my_attr,  mpl::true_, mpl::false_)
        {
            ...
            append_to_container_not_string(val, my_attr, is_value_type());
        }

        ///////////////////////////////////////////////////////////////////////
        // T is a string
        template <typename Iterator>
        static void append_to_string(Attribute& my_attr, Iterator begin, Iterator end)
        {
            for (Iterator i = begin; i != end; ++i)
                traits::push_back(my_attr, *i);
        }

        // T is string, but not convertible to value_type of container
        template <typename T_>
        static void append_to_container(T_ const& val, Attribute& my_attr, mpl::false_)
        {
            typedef typename char_type_of<T_>::type char_type;

            append_to_string(my_attr, traits::get_begin<char_type>(val)
              , traits::get_end<char_type>(val));
        }

        // T is string, and convertible to value_type of container
        template <typename T_>
        static void append_to_container(T_ const& val, Attribute& my_attr, mpl::true_)
        {
            traits::push_back(my_attr, val);
        }

        template <typename T_, typename Pred>
        static void call(T_ const& val, Attribute& my_attr, Pred, mpl::true_)
        {
            typedef typename container_value<Attribute>::type value_type;
            typedef typename is_convertible<T, value_type>::type is_value_type;

            append_to_container(val, my_attr, is_value_type());
        }

        ///////////////////////////////////////////////////////////////////////
        static void call(T const& val, Attribute& my_attr)
        {
            typedef typename traits::is_container<T>::type is_container;
            typedef typename traits::is_string<T>::type is_string;

            call(val, my_attr, is_container(), is_string());
        }
    };
    ...
    namespace detail
    {
        ...
        template <typename T, typename Attribute>
        inline void
        assign_to(T const& val, Attribute& my_attr, mpl::false_)
        {
            assign_to_attribute_from_value<Attribute, T>::call(val, my_attr);
        }
        ...
        template <typename T, typename Attribute>
        inline void
        assign_to(T const& val, Attribute& my_attr, mpl::true_)
        {
            assign_to_container_from_value<Attribute, T>::call(val, my_attr);
        }
    }

    template <typename T, typename Attribute>
    inline void
    assign_to(T const& val, Attribute& my_attr)
    {
        ...
        detail::assign_to(val, my_attr, is_not_wrapped_container());
    }
