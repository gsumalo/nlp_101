...
namespace boost { namespace spirit { namespace char_encoding
{
    ...
    const unsigned char iso8859_1_char_types[] =
    {
        ...
        /*  Š  166  a6 */   BOOST_CC_PUNCT,
        /*  §  167  a7 */   BOOST_CC_PUNCT,
        /*  š  168  a8 */   BOOST_CC_PUNCT,
